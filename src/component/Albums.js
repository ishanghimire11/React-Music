            ...
            <div className="Albums-container">
                <div className="albums">
                    ...
                    <div>
                        ...
                        <span className="listen">Listen On: <i className="fa-brands fa-spotify"></i> <i className="fa-brands fa-soundcloud"></i><i className="fab fa-youtube"></i><i className="fa-brands fa-napster"></i></span>
                    </div>
